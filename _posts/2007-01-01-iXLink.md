...
Companies do this using a variety of factors (price, quality, etc.). A large challenges in the industry was that - to my surprise at the time – telecom providers used mostly Microsoft Excel spreadsheets to exchange pricing information between them.

Now, imagine hundreds of companies exchanging Excel files and - as you can imagine - each of them with a different format.
